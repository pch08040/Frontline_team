...
function header_info(){
	document.querySelector("header").style.backgroundColor = "rgb(106, 156, 231)";
	document.querySelector(".header_logo a img").setAttribute("src", "resources/images/logo_yellow_white.png");
	document.querySelector(".header_img").setAttribute("src", "resources/images/menu.png");
}