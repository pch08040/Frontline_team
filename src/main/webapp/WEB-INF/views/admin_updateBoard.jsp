...
<body>
	...
	<main>
		...
		<section>
			...
			<p>지역번호 : ${updateBoardDTO.regionSeq} <input type="button" value="수정" id="regionSeq"></p>
			<p>타입번호 : ${updateBoardDTO.typeSeq} <input type="button" value="수정" id="typeSeq"></p>
			<p>제목 : ${updateBoardDTO.boardTitle} <input type="button" value="수정" id="boardTitle"></p>
			<p>주소 : ${updateBoardDTO.boardAddress} <input type="button" value="수정" id="boardAddress"></p>
			<p>영업시간 : ${updateBoardDTO.boardOpen} <input type="button" value="수정" id="boardOpen"></p>
